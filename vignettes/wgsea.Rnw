...
homepage: \texttt{http://www-gene.cimr.cam.ac.uk/staff/wallace} \\
...
\section{Addressing potential confounding using propensity scores}
...
using propensity score weights\cite{rosenbaum83,rosenbaum87}.
